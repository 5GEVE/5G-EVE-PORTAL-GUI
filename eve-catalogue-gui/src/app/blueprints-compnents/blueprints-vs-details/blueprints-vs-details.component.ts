...
export class BlueprintsVsDetailsComponent implements OnInit {
  ...
  constructor(public vsbDetailservice: VsbDetailsService, private  blueprintsVsService: BlueprintsVsService) {}
  ...
  getVsBlueprint(vsbId: string) {
    ...
    this.blueprintsVsService.getVsBlueprint(vsbId).subscribe((vsBlueprintInfo: VsBlueprintInfo) => 
      {
       console.log("vsBlueprintInfovsBlueprintInfovsBlueprintInfo",vsBlueprintInfo)
...
export class BlueprintsVsDetailsComponent implements OnInit {
  ...
  constructor(public vsbDetailservice: VsbDetailsService,
